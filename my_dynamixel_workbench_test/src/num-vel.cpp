...
int main(int argc,char **argv)
{
	...
	// A_sys(0,0)=1.0016; A_sys(0,1)=0.6449; A_sys(1,0)=0.0057; A_sys(1,1)=2.6086;
	// B_sys(0,0)=0.0111; B_sys(1,0)=0.0565;	//dt/1000000;
	// C_sys(0,0)=1; C_sys(0,1)=0.0;
	// L_sys(0,0)=2.7102; L_sys(1,0)=7.2263;

	A_sys(0,0)=1; A_sys(0,1)=0.3; A_sys(1,0)=0; A_sys(1,1)=0;
	B_sys(0,0)=0; B_sys(1,0)=0.229*2*PI/60;	//dt/1000000;
	C_sys(0,0)=1; C_sys(0,1)=0.0;
	L_sys(0,0)=0.1; L_sys(1,0)=0.6667;
	
	// A_sys(0,0)=0.9374; A_sys(0,1)=0.1571; A_sys(1,0)=-0.3715; A_sys(1,1)=-14.2756;

	// L_sys(0,0)=-14.2; L_sys(1,0)=1379.9;
